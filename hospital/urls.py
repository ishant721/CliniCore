...
urlpatterns = [
    ...
    path('otp-verify/<int:user_id>/<slug:purpose>/<slug:reset_password>/', views.otp_verify, name='otp_verify'),
    path('reset-password-confirm-otp/<int:user_id>/', views.password_reset_confirm_otp, name='password_reset_confirm_otp'),
    ...
    path('test-add-to-cart/<str:pk>/<str:pk2>/', views.test_add_to_cart, name="test-add-to-cart"),
    path('patient-prescription-medicines/', views.patient_prescription_medicines, name="patient-prescription-medicines"),
    path('add-prescription-medicine-to-cart/<int:medicine_id>/', views.add_prescription_medicine_to_cart, name="add-prescription-medicine-to-cart"),
